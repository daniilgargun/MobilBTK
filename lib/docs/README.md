...
### Лицензия
Данное программное обеспечение является проприетарным и защищено законами об авторском праве. Все права принадлежат исключительно автору. Использование, копирование, распространение или модификация без письменного разрешения автора строго запрещены.

This software is proprietary and protected by copyright laws. All rights belong exclusively to the author. Use, copying, distribution, or modification without written permission from the author is strictly prohibited.

### Подтверждение авторства
- Весь исходный код написан лично Данилом Гаргуном
- Приложение разработано с нуля без использования чужого кода
- Автор является единственным владельцем всех прав на данное ПО
- Создано в 2024 году

Для получения лицензии на использование обращайтесь к автору по указанным выше контактам.